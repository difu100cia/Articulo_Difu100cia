...
%----------------------------------------------------------------------------------------
%	PAQUETES Y DOCUMENTOS DE CONFIGURACION
%----------------------------------------------------------------------------------------

\documentclass[12pt, letterpaper]{difu100cia} % clase difu100cia

%Para cambiar de idioma, este se realiza comentando una de las siguientes líneas en difu100cia.cls
%\usepackage[spanish, mexico]{babel} % Spanish language hyphenation
...
\title{Análisis de desempeño de un filtro FIR en RFNoC} % Titulo del articulo

% Autores
\author[1]{\authorstyle{Grecia Montoya-Zúñiga}\thanks{Gracias al programa de Apoyo a la Incorporación de NPTC en el proyecto denominado ``Implementación de aceleradores de hardware a través de RFNoC en radio definido por software'' por la beca de tesis.}}
\author[1]{\authorstyle{Víktor I. Rodríguez-Abdalá}}
